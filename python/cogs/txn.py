...
class txn(cogcore):
  ...
  async def txn(self,ctx, eth_address: str):
    BUTTONS = ["◀️","▶️"]
    url1='https://api.polygonscan.com/api?module=account&action=txlist&address='+eth_address+'&startblock=0&endblock=99999999&page=1&offset=10&sort=dsc&apikey='+etherscan_api_key #api url
